...
export interface CasinoInterface extends utils.Interface {
  functions: {
    ...
    "casinoBalance()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "casinoBalance",
    values?: undefined
  ): string;
...
export interface Casino extends BaseContract {
  ...
  functions: {
    ...
    casinoBalance(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    casinoBalance(overrides?: CallOverrides): Promise<PopulatedTransaction>;
